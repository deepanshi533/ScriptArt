        ...
        <div className="footer">
            <div className="footer_container">
                ...
                <p>
                    ...
                    <a href='https://github.com/Aniket021978/handwritting' target="_blank" rel="noopener noreferrer">
            ...
            <div className="footer_hrt">
                <h3>Made with <span role="img" aria-label="necro">❤️</span> by <a href='https://github.com/Aniket021978' target="_blank" rel="noopener noreferrer">Deepanshi</a></h3>
            </div>
